"use strict";
{
     ...
     */
    /**
     * @classdesc Mail editor instance class.
     * @extends external:IInstanceBase
     */
    class DesktopBGEditorInstance extends SDK.IInstanceBase {
        constructor(sdkType, inst) {
            super(sdkType, inst);
        }
    };
    SDK.Plugins.RobotKaposzta_DesktopBG.Instance = DesktopBGEditorInstance;
};